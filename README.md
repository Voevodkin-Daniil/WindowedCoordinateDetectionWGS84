...
Библиотека классов C# для триангуляции координат и наземного объекта. Проект включает в себя алгоритмы решения геодезических задач, пересчета координат между различными датумами (WGS-84, ГСК-2011, ПЗ-90.11, СК-42/95) и методы проецирования (Гаусса-Крюгера).
...
|---------------------|--------------------------|
| Широта ОО1          | 53,2015043 °             |
| Долгота ОО1         | 50,1133423 °             |
| Высота ОО1          | -10 М                    |
| Широта ОО2          | 53,2000976 °             |
| Долгота ОО2         | 50,1125830 °             |
| Высота ОО2          | 13 М                     |
| Широта Наблюдателя  | 53,2017412 °             |
| Долгота Наблюдателя | 50,1117721 °             |
| Высота Наблюдателя  | 170 М                    |
| Широта Объекта      | 53,2007990 °             |
| Долгота Объекта     | 50,1142422 °             |
| Высота Объекта      | 20 М                     |
...
| L БПЛА-ОО1           | 210,01 М                 |
| L БПЛА-ОО2           | 247,08 М                 |
| L БПЛА-ЦЕЛЬ          | 246,46 М                 |
| Азимут Цель-БПЛА-ОО1 | -18,32 °                 |
| Азимут Цель-БПЛА-ОО2 | 41,07 °                  |
| Угол места ОО1       | -58,99 °                 |
| Угол места ОО2       | -39,45 °                 |
| Угол места Цель      | 41,07 °                  |

### Работоспособность оконного приложения

> ![Image Alg](image/StartForm.png)    
> **Рисунок 1:** Интерфейс программы для ввода исходных данных (координаты наблюдателей, дальности, углы) и отображения результатов.

> ![Image Alg](image/EndForm.png)    
> **Рисунок 2:** Процесс вычисления координат. Найденная позиция наблюдателя и рассчитанный объект. В таблице результатов отображаются координаты в различных системе (WGS-84).
